...
// Query: *[_type == "startup" && defined(slug.current) && !defined($search) || title match $search || category match $search || author->name match $search ] | order(_createdAt desc) {        _id,        title,        _createdAt,        author -> {            _id, name, image, bio        },        views,        description,        category,        image    }
...
// Query: *[_type == "startup" && _id == $id][0] {        _id,        title,        _createdAt,        author -> {            _id, username, name, image, bio        },        views,        description,        category,        image,        pitch    }
...
// Query: *[_type == "startup" && author._ref == $id] | order(_createdAt desc) {        _id,        title,        _createdAt,        author -> {            _id, name, image, bio        },        views,        description,        category,        image    }
